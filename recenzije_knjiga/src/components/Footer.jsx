    ...
    <footer className="footer">
      <div className="footer-container">
        ...
        <div className="footer-col">
          ...
          <img src={logo} alt="Књигоказ логотип" className="footer-logo-image" />
          <p>
            Твој водич кроз свет књижевности. Откриј нове књиге,
            ауторе и рецензије које инспиришу.
          </p>
        </div>
  ...
  <li class="icon-content">
    ...
    <div class="tooltip">Mail</div>
      ...
      <div className="footer-bottom">
        <p>© 2026 Књигоказ — Сва права задржана</p>
      </div>
    </footer>
  );
};
